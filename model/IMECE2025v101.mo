model IMECE2025v101
  ...
  PhysicsBasedPredictionRUL.detailedFC fc(N = 300, N_m = 8)  annotation(
    Placement(visible = true, transformation(origin = {20, 32}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  PhysicsBasedPredictionRUL.simpleTank tank(Cv = 0.6)  annotation(
  ...
  PhysicsBasedPredictionRUL.flightCycle cycle(cruiseP(displayUnit = "kW") = 154000, cruiseTime = 2700, maxP(displayUnit = "kW") = 212000, maxRamp = 30, maxTime = 180, sigma = 2554.4, taxiP(displayUnit = "kW") = 41000, taxiRamp = 60, taxiTime = 592)  annotation(
  ...
  PhysicsBasedPredictionRUL.LCO_CellStackTC stack(CycleLife = 425,SOCini = 1, cellParameters = batParams, np = 48, ns = 168)  annotation(
